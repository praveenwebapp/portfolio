...
const Contact = () => {
  ...
  return (
    ...
    id ='Contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/navbg.jpeg")] bg-no-repeat bg-cover bg-[length:100%_auto] dark:bg-none'>
         <motion.h4 
...
Feel free to reach out to me through the contact form, or you can email me directly at praveenkmaddelafullstack@gmail.com
      </motion.p>
      <motion.form 
...
transition={{ delay : 1.3 , duration: 0.6 }}
        ...
        className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'  type='submit'> Submit Now <Image src={''} alt="" className="w-4"/></motion.button>
